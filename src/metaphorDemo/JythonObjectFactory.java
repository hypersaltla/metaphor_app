 ...
 *the PythonInterpreter, which is known to be poor for performance.  
 *By utilizing the PySystemState, we can obtain a reference to the importer.  
 *In turn, we can use the importer to obtain reference to our Jython module.
 *@author jimbaker
*/
